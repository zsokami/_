...
'''
print(requests.get('http://localhost/sub?target=clash&list=true&udp=true&scv=true&config=https://raw.githubusercontent.com/zsokami/ACL4SSR/main/ACL4SSR_Online_Full_Mannix.ini&url=data:text/plain;base64,'+urlsafe_b64encode(sub)).text)
